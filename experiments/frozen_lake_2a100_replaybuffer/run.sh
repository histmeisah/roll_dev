#!/bin/bash
# ==============================================================================
# FrozenLake Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - traj_baseline      : Trajectory level baseline
#     - step_baseline      : Step level baseline
#
#   Off-Policy with Standard PER:
#     - traj_per           : Trajectory level + reward priority + IS
#     - step_per           : Step level + reward priority + IS
#
#   Off-Policy with Reward-Fresh (our extension):
#     - traj_reward_fresh  : Trajectory level + reward_fresh + IS
#     - step_reward_fresh  : Step level + reward_fresh + IS
#
#   Off-Policy with N-Step Returns (step level only):
#     - step_per_nstep          : Step level + PER + 5-step returns
#     - step_reward_fresh_nstep : Step level + reward_fresh + 5-step returns
#
#   Off-Policy with V-trace (step level only):
#     - step_per_vtrace          : Step level + PER + V-trace
#     - step_reward_fresh_vtrace : Step level + reward_fresh + V-trace
# ==============================================================================
set -e
...
echo "========================================"
echo "FrozenLake Experiment: ${CONFIG_NAME}"
echo "========================================"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/frozen_lake_2a100_replaybuffer \
