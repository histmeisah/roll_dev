#!/bin/bash
# ==============================================================================
# Hard Sokoban Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - sokoban_hard_traj_baseline_configA            : Trajectory baseline, Config A
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - sokoban_hard_traj_reward_fresh_configA_age1000 : age_decay=1000 (best on FL)
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - sokoban_hard_traj_reward_fresh_configA_age1000 : age_decay=1000 (best on FL)
#
#   Off-Policy with Advantage PER:
#     - sokoban_hard_traj_advantage_per_configA        : advantage-based PER
#
# Environment: LargerSokoban (8x8, 2 boxes, max_actions=20)
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="sokoban_hard_traj_baseline_configA"
# =============================================================================
...
echo "========================================"
echo "Hard Sokoban Experiment: ${CONFIG_NAME}"
echo "========================================"
echo "Timestamp: $TIMESTAMP"
echo "Config: ${CONFIG_NAME}.yaml"
echo "Log file: $LOG_FILE"
echo "Output directory: $OUTPUT_DIR"
echo "Environment: LargerSokoban (8x8, 2 boxes)"
echo "========================================"
