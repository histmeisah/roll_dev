#!/bin/bash
# ==============================================================================
# AIME Math Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - aime_traj_baseline_configA
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - aime_traj_reward_fresh_configA
#
#   Off-Policy with Advantage PER:
#     - aime_traj_advantage_per_configA
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="aime_traj_baseline_configA"
# =============================================================================
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/math_aime_2a100_replaybuffer \
