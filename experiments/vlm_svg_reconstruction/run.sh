#!/bin/bash
# ==============================================================================
# VLM SVG Reconstruction Experiments Runner - 4x H100
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - traj_baseline      : VLM Trajectory baseline
#
#   Off-Policy with Standard PER:
#     - traj_per           : VLM + Trajectory level + reward priority + IS
#
#   Off-Policy with Reward-Fresh (our extension):
#     - traj_reward_fresh  : VLM + Trajectory level + reward_fresh + IS
# ==============================================================================
set -e
...
echo "========================================"
echo "VLM SVG Reconstruction Experiment: ${CONFIG_NAME}"
echo "========================================"
...
echo "  GPU 0-1: actor_train + reference"
echo "  GPU 2-3: actor_infer (vLLM)"
echo "========================================"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/vlm_svg_reconstruction \
