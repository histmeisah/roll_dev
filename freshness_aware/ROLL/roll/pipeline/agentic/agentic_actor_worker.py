...
class ActorWorker(BaseActorWorker):
    def loss_func(self, data: DataProto, output_tensor: torch.Tensor):
        ...
        # PER importance-sampling correction. GroupReplayBuffer/TrajectoryReplayBuffer
        # attach one weight per sampled trajectory; agg_loss broadcasts it over tokens.
