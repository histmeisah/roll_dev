...
#SBATCH --chdir=/mnt/data/u/maw0a/python_project/freshness_aware/experiments/sokoban_hard_8gpu_kl_fresh
#SBATCH --output=/mnt/data/u/maw0a/python_project/freshness_aware/experiments/sokoban_hard_8gpu_kl_fresh/output/slurm/%x_%j.out
#SBATCH --error=/mnt/data/u/maw0a/python_project/freshness_aware/experiments/sokoban_hard_8gpu_kl_fresh/output/slurm/%x_%j.err

set -euo pipefail

CONFIG_NAME="${1:-sokoban_hard_reinforce_kl_fresh_qwen3_8b_8gpu_smoke}"
SCRIPT_DIR="/mnt/data/u/maw0a/python_project/freshness_aware/experiments/sokoban_hard_8gpu_kl_fresh"
