#!/bin/bash
# ==============================================================================
# MATH (Hendrycks) Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - math_traj_baseline_configA
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - math_traj_reward_fresh_configA
#
#   Off-Policy with Advantage PER:
#     - math_traj_advantage_per_configA
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="math_traj_baseline_configA"
# =============================================================================
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/math_hendrycks_2a100_replaybuffer \
