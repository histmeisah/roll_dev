#!/bin/bash
# ==============================================================================
# 4-GPU AIME GRPO 200-step job on public freecycle H200.
# Usage: sbatch -J aime-grpo4-freshper experiments/grpo_aime/sbatch_4gpu_200step.sh aime_grpo_4h200_reward_fresh_per_200step
# ==============================================================================
