#!/bin/bash
# ==============================================================================
# 4-GPU AIME GRPO replay tuning job on public freecycle H200.
# Usage: sbatch -J aime-grpo4-b256 experiments/grpo_aime/sbatch_4gpu_tune.sh aime_grpo_4h200_freshper_tune_b256_20step
# ==============================================================================
...
CONFIG_NAME="${1:-${CONFIG_NAME:-aime_grpo_4h200_freshper_tune_b256_20step}}"
