#!/bin/bash
# ==============================================================================
# MATH Hendrycks Experiments Runner - 8x H100
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - math_traj_baseline_8gpu      : MATH Hendrycks Trajectory baseline
#
#   Off-Policy with Reward-Fresh:
#     - math_traj_reward_fresh_8gpu  : MATH + reward_fresh + age_decay=1000
#
#   Off-Policy with Advantage PER:
#     - math_traj_advantage_per_8gpu : MATH + advantage-based priority
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="math_traj_baseline_8gpu"
# =============================================================================
...
echo "========================================"
echo "MATH Hendrycks Experiment: ${CONFIG_NAME}"
echo "========================================"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/math_hendrycks_8h100_replaybuffer \
