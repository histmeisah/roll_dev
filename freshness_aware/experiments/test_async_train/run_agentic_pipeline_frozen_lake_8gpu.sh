...
# 设置环境变量，确保ROLL使用正确的输出目录
export ROLL_OUTPUT_DIR="$SCRIPT_DIR/output"
...
echo "Starting ROLL Agentic Pipeline with 8 GPUs..."
echo "Config: agent_val_frozen_lake_async_8gpus.yaml"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/test_async_train \
    --config_name agent_val_frozen_lake_async_8gpus
