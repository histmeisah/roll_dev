#!/bin/bash
# ==============================================================================
# CliffWalking Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - cliffwalking_traj_baseline_configA          : Trajectory baseline, Config A
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - cliffwalking_traj_reward_fresh_configA_age500  : age_decay=500  (aggressive)
#     - cliffwalking_traj_reward_fresh_configA_age1000 : age_decay=1000 (best on FL)
#     - cliffwalking_traj_reward_fresh_configA_age1500 : age_decay=1500 (conservative)
#
#   Off-Policy with Advantage PER:
#     - cliffwalking_traj_advantage_per_configA        : advantage-based PER
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="cliffwalking_traj_baseline_configA"
# =============================================================================
...
echo "========================================"
echo "CliffWalking Experiment: ${CONFIG_NAME}"
echo "========================================"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/cliffwalking_2a100_replaybuffer \
