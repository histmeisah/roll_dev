#!/bin/bash
# ==============================================================================
# Sokoban Experiments Runner - 2xA100 40GB
# ==============================================================================
# Available configs:
#   Baseline (no replay):
#     - sokoban_traj_baseline_configA          : Trajectory baseline, Config A
#
#   Off-Policy with Reward-Fresh + Age Decay:
#     - sokoban_traj_reward_fresh_configA_age500  : age_decay=500  (aggressive)
#     - sokoban_traj_reward_fresh_configA_age1000 : age_decay=1000 (best on FL)
#     - sokoban_traj_reward_fresh_configA_age1500 : age_decay=1500 (conservative)
#
#   Off-Policy with Advantage PER:
#     - sokoban_traj_advantage_per_configA        : advantage-based PER
# ==============================================================================
set -e
...
# =============================================================================
CONFIG_NAME="sokoban_traj_baseline_configA"
# =============================================================================
...
echo "========================================"
echo "Sokoban Experiment: ${CONFIG_NAME}"
echo "========================================"
...
python examples/start_agentic_pipeline.py \
    --config_path ../../experiments/sokoban_2a100_replaybuffer \
