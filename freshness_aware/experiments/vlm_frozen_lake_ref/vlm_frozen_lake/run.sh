#!/bin/bash
# ==============================================================================
# VLM FrozenLake Experiments Runner
# ==============================================================================
# Available configs:
#   Baseline (no replay):
...
source ~/miniconda3/bin/activate 2>/dev/null || source /opt/conda/bin/activate 2>/dev/null || true
...
# Set visible GPUs (modify based on your hardware)
...
echo "========================================"
echo "VLM FrozenLake Experiment: ${CONFIG_NAME}"
echo "========================================"
